...
The Notification Service is a Kafka-based microservice that consumes messages from multiple Kafka topics and sends email notifications to users. It acts as the notification delivery system for the entire Nexus platform, handling both generic email notifications and order-specific notifications.
